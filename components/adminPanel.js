...
import Logo from '../images/HR-app_logo-white.svg';
        ...
        return (
            ...
            <div class="content">
                <div class="date centered-content margin-top-25">
                    <div class="start-date"> 
                        ...
                        <input class="margin-right-25" type="date" id="start" min="2021-01-01" max="2030-12-31"/>
                    ...
                    <div class="end-date"> 
                        <label class="start-date-label" for="start">End date:</label>
                        <input class="margin-right-25" type="date" id="start" min="2021-01-01" max="2030-12-31"/>
                        {/*<button>save</button> in case button is needed*/}
                        {/*
                        input calendar
            ...
            <div class="footer">
                ...
                <div class="contacts">
                    ...
                    <a href="" class="help_center">Help Center </a>
